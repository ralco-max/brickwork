...
export const defaultBrief=(idea=""):DesignBrief=>({idea,size:"medium",detail:"detailed",maxPieces:3500,maxWidth:48,maxDepth:40,maxHeight:120,features:[],style:"Sculptural display with rich surface detail",hollow:false});
