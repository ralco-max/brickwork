...
const schema=z.object({revision:z.string().max(2000).optional(),brief:briefSchema,images:z.array(z.string().max(750000).regex(/^data:image\/jpeg;base64,[A-Za-z0-9+/=]+$/)).length(3)}).strict();
